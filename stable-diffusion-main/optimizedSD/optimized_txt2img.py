# https://old.reddit.com/r/StableDiffusion/comments/wuyu2u/how_do_i_run_stable_diffusion_and_sharing_faqs/ilcodqd/
import sys
sys.path.append('D:/_python/EcosphereWork/stable-diffusion-main')
